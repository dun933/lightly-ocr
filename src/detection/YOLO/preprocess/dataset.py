...
class DetectorDataset:
    '''using synthtext as datasett'''
    def __init__(self, generator, input_shape, batch_size, buffer_size, prefetch_size):
    ...
    def read_and_resize_image(self, element):
        ...
        img = self.resize_image(img, self.input_shape)
        element['image'] = img
        # format label
...
class ClassifierDataset:
    '''on the other this one use coco'''
