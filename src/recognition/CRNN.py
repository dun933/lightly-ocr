...
def crnn(input_tensor=None, input_shape=None, hidden_size=256, num_classes=1000, label_len=16, characters='', backbone='efficientnet', weights='imagenet', training=False, **kwargs):
