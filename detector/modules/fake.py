...
from .conv import collect_input_shape
from utils.gaussian import GaussianGenerator
from utils.box import cal_affinity_boxes, reorder_points
...
class Fake(Layer):
    ...
    def compute_output_shape(self, input_shape):
        output_shape = [collect_input_shape(self.input_region),
                        collect_input_shape(self.input_affinity),
                        collect_input_shape(self.input_confidence),
                        ]
        return output_shape
    ...
    def call(self, inputs, **kwargs):
        def tf_create_pseudo_gt(input_box, input_word_length, input_region, input_affinity,
            ...
            return tf.py_function(func=create_pseudo_gt,
        ...
        new_region.set_shape(collect_input_shape(self.input_region))
        new_affinity.set_shape(collect_input_shape(self.input_affinity))
        new_confidence.set_shape(collect_input_shape(self.input_confidence))
