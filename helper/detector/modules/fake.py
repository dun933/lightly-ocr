...
from .helpers import _collect_input_shape
from .utils import *
...
def create_pseudo_gt(word_boxes, word_lengths, region, affinity, confidence, pred_region):
    ...
    value of confidence map over each word box is computed proportional to the # of detected characters / # of ground truth characters
    '''
