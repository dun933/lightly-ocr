...
def crnn(input_tensor=None, input_shape=None, hidden_size=256, num_classes=1000, backbone='efficientnet', training=False, **kwargs):
    ...
    if backbone == 'efficientnet':
        back_out = efficientnetB3(input_tensor=inputs, num_classes=num_classes).output
    elif backbone == 'resnet':
        back_out = resnet50v2(input_tensor=inputs, num_classes=num_classes).output
    else:
